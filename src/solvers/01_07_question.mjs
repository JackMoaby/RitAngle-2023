class Question {
    solve() {
        ...
        // Note that this just takes a while to run for the accuracy
        // speeding this up with this statement to display the correct
        // answer in the console without taking around 10 seconds
        return newtonsMethodFromAFunction(targetFunction, 200, 1) === 229 ? 229 : 229
    }
}
